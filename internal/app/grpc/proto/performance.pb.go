...
func (x *TeamStatRequest) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
func (x *TeamStatRequest) GetGames() uint32 {
	if x != nil {
		return x.Games
	}
	return 0
...
func (x *TeamStatRequest) GetMeasure() string {
	if x != nil {
		return x.Measure
	}
	return ""
...
func (x *TeamStatRequest) GetMetric() string {
	if x != nil {
		return x.Metric
	}
	return ""
...
func (x *TeamStatRequest) GetSeasons() []uint64 {
	if x != nil {
		return x.Seasons
	}
	return nil
...
func (x *TeamStatRequest) GetValue() float32 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *TeamStatRequest) GetVenue() string {
	if x != nil {
		return x.Venue
	}
	return ""
...
var file_internal_app_grpc_proto_performance_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcb, 0x01, 0x0a, 0x0f, 0x54, 0x65, 0x61, 0x6d, 0x53,
	0x74, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x63,
	...
	0x65, 0x6e, 0x75, 0x65, 0x22, 0x35, 0x0a, 0x10, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x74, 0x61, 0x74,
	...
	0x54, 0x65, 0x61, 0x6d, 0x52, 0x05, 0x74, 0x65, 0x61, 0x6d, 0x73, 0x32, 0x5f, 0x0a, 0x12, 0x50,
	0x65, 0x72, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x49, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x54, 0x65, 0x61, 0x6d, 0x73, 0x4d, 0x61, 0x74,
	0x63, 0x68, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x12, 0x16, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x74,
	0x61, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x19, 0x5a, 0x17,
...
var file_internal_app_grpc_proto_performance_proto_goTypes = []interface{}{
	(*TeamStatRequest)(nil),  // 0: proto.TeamStatRequest
...
var file_internal_app_grpc_proto_performance_proto_depIdxs = []int32{
	...
	0, // 1: proto.PerformanceService.GetTeamsMatchingStat:input_type -> proto.TeamStatRequest
...
type PerformanceServiceClient interface {
	GetTeamsMatchingStat(ctx context.Context, in *TeamStatRequest, opts ...grpc.CallOption) (*TeamStatResponse, error)
}
...
func (c *performanceServiceClient) GetTeamsMatchingStat(ctx context.Context, in *TeamStatRequest, opts ...grpc.CallOption) (*TeamStatResponse, error) {
...
type PerformanceServiceServer interface {
	GetTeamsMatchingStat(context.Context, *TeamStatRequest) (*TeamStatResponse, error)
}
...
func (*UnimplementedPerformanceServiceServer) GetTeamsMatchingStat(context.Context, *TeamStatRequest) (*TeamStatResponse, error) {
...
func _PerformanceService_GetTeamsMatchingStat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PerformanceServiceServer).GetTeamsMatchingStat(ctx, req.(*TeamStatRequest))
	}
